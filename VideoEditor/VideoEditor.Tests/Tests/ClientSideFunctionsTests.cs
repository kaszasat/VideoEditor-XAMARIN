...
{
    internal class ClientSideFunctionsTests
    {
        [Test]
        public void ClientSideFunctionsSingleton()
        {
            var client1 = Model.ClientSideFunctions.Instance;
            var client2 = Model.ClientSideFunctions.Instance;
        ...
        {
            int length = 8;
            string randomString = Model.ClientSideFunctions.RandomString(length);
        ...
        public void RandomStringLengthBiggest()
        {
            ...
            Assert.Throws<System.OutOfMemoryException>(() => Model.ClientSideFunctions.RandomString(length));
        }
        ...
        {
            int length = -10;
            Assert.Throws<System.ArgumentOutOfRangeException>(() => Model.ClientSideFunctions.RandomString(length));
        }
        ...
        public void HoursMinutesSecondsConverterSecond()
        {
            ...
            var convertedTimeValues = Model.ClientSideFunctions.HoursMinutesSecondsConverter(lowerValue, uppwervalue);
            Assert.Multiple(() =>
            {
